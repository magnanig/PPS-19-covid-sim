...
import pps.covid_sim.parameters.CreationParameters.{barPercentage, companyPercentage, discoPercentage,
  factoryPercentage, footballTeamPercentage, freeTimePlacePercentage, gymPercentage, hobbyPercentage,
  openDiscoPercentage, pubPercentage, restaurantsPercentage, shopPercentage}
...
private class ProvincePlacesCreation(val province: Province) {

  private val _people: List[Person] = ProvincePeopleCreation.create(province)
